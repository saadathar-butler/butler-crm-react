        ...
        <aside>
            ...
            <div class="sidebar left sidebarCalls">
                ...
                {selectedType === "Follow Ups" && newJobs.map((a, i) => {
                    return (
                        a.followUpDate &&
                        <div onClick={() => props.setSelectedItem(a)} style={{ backgroundColor: selectedItem._id === a._id ? 'lightgray' : "white" }} key={i} className='callBoxes'>
                            <p><b>Name: </b>{a.customerName}</p>
                            <p><b>Address: </b>{a.address}</p>
                            <p><b>Service: </b>{JSON.parse(a.service).name}</p>
                            <p><b>description: </b>{a.description}</p>
                        </div>
                    )
                })}
