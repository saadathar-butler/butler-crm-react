...
const Leads = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            fixed: 'right',
            render: (record) => (
                activeUser && activeUser.permissions[0].leadsEdit &&
    ...
    return (
        <div className='mt-3 p-3'>
            <div className='d-flex justify-content-between w-100'>
                <h3 className='mb-4 text-center'>All Leads</h3>
                {activeUser && activeUser.permissions[0].leadsAdd &&
            ...
            <Table
                ...
                dataSource={jobs.sort((a, b) => new Date(b.dateCreated).getTime() - new Date(a.dateCreated).getTime())}
                scroll={scroll}
            />
            {isModalOpen &&
                <Modal
